...
function cargarDataTable() {
    ...
    dataTable = $("#tblPacientes").DataTable({
        ...
        "columns": [
            ...
            { "data": "segundoNombre", "width": "10%" },
            { "data": "primerApellido", "width": "10%" },
            { "data": "segundoApellido", "width": "10%" },
            { "data": "numeroIdentidad", "width": "10%" },
            { "data": "genero", "width": "5%" },
            { "data": "estaActivo", "width": "5%" },
            {
                "data": "pacienteID",
                "render": function (data) {
                    return `<div class="text-center">
                                ...
                                &nbsp;
                                <a onclick=Delete("/Admin/Pacientes/Delete/${data}") class="btn btn-danger text-white" style="cursor: pointer; width: 140px;">
